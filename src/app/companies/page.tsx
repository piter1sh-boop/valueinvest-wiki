  ...
  return (
    <div className="min-h-screen">
      <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="flex gap-6 text-sm">
            ...
            <Link href="/companies" className="nav-link font-bold" style={{ color: '#c9a227' }}>Companies</Link>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold mb-2">Company Profiles</h1>
        <p className="text-gray-600 mb-8">Deep dives into companies with durable competitive advantages.</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {companies.map((company) => (
            ...
            >
              <h2 className="font-bold text-lg mb-2">{company.title}</h2>
