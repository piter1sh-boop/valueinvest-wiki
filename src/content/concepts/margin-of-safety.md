...
description: The principle of buying securities at a price significantly below their intrinsic value, providing protection against errors in calculation or adverse events.
type: concepts
...
**Margin of Safety** is the foundational principle of [[value-investing|value investing]]. It refers to buying a security at a price significantly below its **intrinsic value**, creating a "buffer" that protects against:
...
## [[benjamin-graham|Graham's]] Formulation

[[benjamin-graham|Graham]] taught that the margin of safety should be so large that "an error in calculation or a significant amount of bad luck would be required to produce a loss."
...
## [[warren-buffett|Buffett's]] Evolution

Buffett initially followed Graham's cigar-butt approach (buying very cheap, mediocre businesses). Then [[charlie-munger|Munger]] convinced him:
...
This asymmetry, compounded over many investments, creates the statistical foundation of [[value-investing|value investing's]] long-term superiority.
...
| [[long-term-thinking|Long-term holding]] | Short-term trading |
